...
const CtaDownloadWidget = () => {
  return (
    <div className="row cta-wrap">
      <div className = "text-me-margin cta-text-me text-me-hide col-lg-6 col-md-6 col-sm-6" >
        <iframe frameBorder="0" height="66px" marginHeight="10" marginWidth="0" src="https://api.linktexting.com/linkEmbed/6257b294-41ee-4546-a802-098bce68f1ea?autoIp=true" width="377px"></iframe>
      </div> 
